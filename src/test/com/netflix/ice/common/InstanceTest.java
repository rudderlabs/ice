...
public class InstanceTest {
	...
	public void testSerializer() throws BadZone {
		...
		Instance i = new Instance("i-17f85eef87efb7a53", "c4.2xlarge", account, Region.US_EAST_1, us_east_1a, ps.getProduct(Product.Code.Ec2), tags, 0);
		String[] values = i.values();
		String[] expected = new String[]{"i-17f85eef87efb7a53","c4.2xlarge","123456789012",account.getIceName(),"us-east-1","us-east-1a","AmazonEC2","Environment=prod"};
	...
	public void testTagWithCommas() throws BadZone {
		...
		Instance i = new Instance("i-17f85eef87efb7a53", "c4.2xlarge", account, Region.US_EAST_1, us_east_1a, ps.getProduct(Product.Code.Ec2), tags, 0);
		String[] values = i.values();
		String[] expected = new String[]{"i-17f85eef87efb7a53","c4.2xlarge","123456789012",account.getIceName(),"us-east-1","us-east-1a","AmazonEC2","Name=" + tagValue};
		assertArrayEquals("serialized form wrong", expected, values);
	...
	public void testMultipleTags() throws BadZone {
		...
		Instance i = new Instance("i-17f85eef87efb7a53", "c4.2xlarge", as.getAccountById("123456789012", ""), Region.US_EAST_1, us_east_1a, ps.getProduct(Product.Code.Ec2), tags, 0);
		String[] values = i.values();
		Instance got = new Instance(values, as, ps);
	...
	public void testNoZone() throws BadZone {
		...
		Instance i = new Instance("i-17f85eef87efb7a53", "c4.2xlarge", as.getAccountById("123456789012", ""), Region.US_EAST_1, null, ps.getProduct(Product.Code.Ec2), tags, 0);
		String[] values = i.values();
		Instance got = new Instance(values, as, ps);
		assertEquals("tags size is wrong", i.tags.size(), got.tags.size());
	}
